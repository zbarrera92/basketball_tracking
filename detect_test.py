...
video_path   = "./basketball-videos/made-basket-tracker/player-tracker.mp4"
video_path_end   = "./basketball-videos/made-basket-tracker/player-tracker-tracked.mp4"
color_ratio_list = []

yolo = Load_Yolo_model()
#detect_image(yolo, image_path, "./IMAGES/kite_pred.jpg", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))

detect_video(yolo, video_path, video_path_end, input_size=YOLO_INPUT_SIZE, show=False, rectangle_colors=(255,0,0))
